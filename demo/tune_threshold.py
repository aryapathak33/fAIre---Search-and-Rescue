...
This reads the metrics generated by a future real-probability evaluator, but also
keeps a small demo mode so the concept is runnable without your private dataset.
...
def main() -> None:
    args = parse_args()
    if not args.demo:
        raise SystemExit("Use --demo for now. After evaluation saves real probabilities, wire them in here.")
